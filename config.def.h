...
static const int showtags = 4; /* Hide tags of an ID greater than this one */
...
/* TODO: update these commands I use
...
static const char *switchcmd[] = { "dmenu-switch", "-m", dmenumon, "-fn", dmenufont, "-nb", normbgcolor, "-nf", normfgcolor, "-sb", selbgcolor, "-sf", selfgcolor, NULL };
